...
parser.add_argument('--data',
                    metavar='DIR',
                    default='/data3/AI/data_fine_tuned/',
...
def main_worker(local_rank, nprocs, args):
    ...
    model.load_state_dict(torch.load('/data3/AI/projects/p2022/feature_model_path/noize_50based/24_epoch0.3470226433650491.pkl',map_location='cpu'))
    if args.pretrained:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        torch.save(model.module.state_dict(),
                os.path.join('/data3/AI/projects/p2022/feature_model_path/save_temp'
                                    , str(epoch) + '_epoch' + str(acc1) + '.pkl'))
